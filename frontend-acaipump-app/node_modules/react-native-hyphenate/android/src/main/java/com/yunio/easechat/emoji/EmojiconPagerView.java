...
import com.yunio.easechat_adapter.EmojiconGridAdapter;
import com.yunio.easechat_adapter.EmojiconPagerAdapter;
                ...
                if (endSize + groupPageSize > position) {
                    ...
                    if (pagerViewListener != null) {
                        pagerViewListener.onGroupInnerPagePostionChanged(
                                previousPagerPosition - endSize, position - endSize);
                    }
                    break;
