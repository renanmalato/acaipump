...
public class EmojiconIndicatorView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        selectedBitmap = BitmapFactory.decodeResource(context.getResources(),
                R.drawable.ease_dot_emojicon_selected);
        unselectedBitmap = BitmapFactory.decodeResource(context.getResources(),
                R.drawable.ease_dot_emojicon_unselected);
