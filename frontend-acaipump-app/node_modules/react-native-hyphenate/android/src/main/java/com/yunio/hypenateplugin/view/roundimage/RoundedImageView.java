...
package com.yunio.hypenateplugin.view.roundimage;
...
public class RoundedImageView extends ImageViewNet {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundedImageView, defStyle,
                0);
        ...
        final int tileMode = a.getInt(R.styleable.RoundedImageView_riv_tile_mode,
                TILE_MODE_UNDEFINED);
        ...
        final int tileModeX = a.getInt(R.styleable.RoundedImageView_riv_tile_mode_x,
                TILE_MODE_UNDEFINED);
        if (tileModeX != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileModeX));
        }

        final int tileModeY = a.getInt(R.styleable.RoundedImageView_riv_tile_mode_y,
                TILE_MODE_UNDEFINED);
    ...
    public Bitmap getDrawableBitmap() {
        if (mDrawable instanceof RoundedDrawable) {
            return ((RoundedDrawable) mDrawable).getBitmap();
        }
        return null;
    }
