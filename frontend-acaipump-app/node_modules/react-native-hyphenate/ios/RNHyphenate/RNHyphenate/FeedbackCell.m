...
- (void)createUI{
    ...
    [_resendButton setBackgroundImage:[AppTool getImageWithName:@"sendFailed"] forState:UIControlStateNormal];
...
- (void)setMessage:(EMMessage *)message{
    ...
    if (message.direction == EMMessageDirectionReceive) {
        ...
        if (image == nil) {
            image = [AppTool getImageWithName:@"icon"];
        }
        ...
        _cellBackImage.image = [[AppTool getImageWithName:@"message_bubble_recive"] stretchableImageWithLeftCapWidth:15 topCapHeight:15];
    ...
    if (message.direction == EMMessageDirectionSend) {
        ...
        _cellBackImage.image = [[AppTool getImageWithName:@"message_bubble_send"] stretchableImageWithLeftCapWidth:15 topCapHeight:15];
