...
//        NSURL *url = [bundle URLForResource:@"PhotoPluginResources" withExtension:@"bundle"];
//        NSBundle *imageBundle = [NSBundle bundleWithURL:url];
      
        _infoImage = [AppTool getImageWithName:@"info"];//[UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"info" ofType:@"png"]];
        _successImage = [AppTool getImageWithName:@"success"];//[UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"success" ofType:@"png"]];
        _errorImage = [AppTool getImageWithName:@"error"];//[UIImage imageWithContentsOfFile:[imageBundle pathForResource:@"error" ofType:@"png"]];
